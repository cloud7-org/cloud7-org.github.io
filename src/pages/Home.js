        ...
        <div className="row no-gutters">
            <ImageBox image="header">
                <HeaderText
                    ...
                    detail="With a fleet of six meticulously maintained and updated Cessna aircraft, the Minneapolis flying organization Cloud 7 is based at the Flying Cloud Airport (KFCM) in Eden Prairie, MN.  Cloud 7 is the perfect place for new pilots through seasoned career pilots."
                />   
            </ImageBox>
        </div>
