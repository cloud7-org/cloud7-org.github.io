    ...
    return <>
        <div className="row no-gutters">
            <ImageBox image="N65045">
                <HeaderText
                    title="About Us"
                    detail="Twin City Cloud 7, Inc. is Minnesota’s leading flying organization, founded in 1966 by seven pilots with one Skyhawk. The purpose then to now has been to provide well-equipped, professionally maintained aircraft at a reasonable cost per hour."
                />   
            </ImageBox>
        </div>
